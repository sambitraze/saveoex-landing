      ...
      <div className="container mx-auto">
        <div className="mx-8 flex flex-wrap items-center">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to SAVEOEX, the software
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to SAVEOEX SALES PRIVATE LIMITED, BLDG
                NO. C/3 BLOCK NO 401, LOK EVEREST JSD ROAD, Mumbai, Mumbai,
                Mumbai- 400080, Maharashtr.
              </p>
            </li>
            <li>
              <p>
